...
Based on the scatter plot of temperature, chirping and species, and a correlation test,
it seems that as temperature increases by 1º Celsius, the chirping rate of the two species of cricket increses at an average of 3.6 chirps per minute.
...
Each species occupies a different temperature range.
We checked for interactions but decided to stay with the species model.
...
## Diamonds Value Prediction

```{r prediction, echo=FALSE}

diamond_model <- lm(price ~ carat + cut + clarity, diamonds)
